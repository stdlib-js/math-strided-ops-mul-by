...
```javascript
import mulBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-ops-mul-by@v0.0.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-ops-mul-by@v0.0.1-esm/index.mjs';
```
...
[@stdlib/math/base/ops/mul]: https://github.com/stdlib-js/stdlib/tree/esm
